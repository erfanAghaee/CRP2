...
def drawRL():
    ...
    adr ="./data/Visual_TCAD/Test11.die.csv"
    die_df = pd.read_csv(adr)
    ...
    db["die"] = die_df
    adr_net = "./data/Visual_TCAD/Test11.net.3.csv"
    db["net"] = pd.read_csv(adr_net, \
        dtype={"l": "float64","xl":'float64',"yl":'float64',"xh":'float64',"yh":"float64"})

    adr_vio = "./data/Visual_TCAD/Test11.vio.3.csv"
    db["vio"] = pd.read_csv(adr_vio, \
            dtype={"l": "float64","xl":'float64',"yl":'float64',"xh":'float64',"yh":"float64"})

    adr_gcell = "./data/Visual_TCAD/Test11.gcell.csv"
    db["gcell"] = pd.read_csv(adr_gcell, \
        dtype={"l":"float64","x":'float64',"y":'float64',"w":'float64',"h":"float64"})
    ...
    for net_name in nets:
        ...
        net_obj.getWindow(window=window,plt_obj=plt_obj,net_name=net_name)
        vio_obj.getWindow(window=window,plt_obj=plt_obj)
        gcell_obj.getWindow(window=window,plt_obj=plt_obj,l=1)



        surface.write_to_png("data/" +f"{net_name}.png")  # Output to PNG
        break
